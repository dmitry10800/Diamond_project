...
namespace Diamond_GC
{
    class Methods
    {
        ...
        public static string DateProcess(string recString)
        {
            ...
            var datePatternTwo = @"(?<year>\d{4})-*(?<month>\d+)-*(?<day>\d+)";
