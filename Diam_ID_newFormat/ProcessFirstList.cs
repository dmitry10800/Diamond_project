                        ...
                        if (tmpRecordValue != null)
                        {
                            ...
                            foreach (var inidCode in splittedRecord)
                            {
                                ...
                                if (inidCode.StartsWith(I22))
                                {
                                    ...
                                    //currentElement.I22 = Methods.PrioDateNormalize(currentElement.I22);
                                }
                                if (inidCode.StartsWith(I30))
                                {
                                    var processedPrio = Methods.PrioritySplitNewFormat(inidCode);
                                ...
                                if (inidCode.StartsWith(I51))
                                {
                                    ...
                                    {
                                        if (processedValue.Date != null) 
                                            currentElement.I51D = processedValue.Date;
                                        currentElement.I51C = processedValue.Class;
                                        if (processedValue.NotesValue != null) 
                                            currentElement.I51Notes = processedValue.NotesValue;
                                    }
                                }
                                ...
                                {
                                    var owner = Methods.Process71Inid(inidCode.Replace(I71, "").Trim());
                                    currentElement.I71N = owner.Name; 
                                    currentElement.I71A = owner.Address; 
                                    currentElement.I71C = owner.Country;
                                }
