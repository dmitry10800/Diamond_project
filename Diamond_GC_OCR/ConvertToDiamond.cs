...
namespace Diamond_GC_OCR
{
    class ConvertToDiamond
    {
            ...
            if (elementOuts != null)
            {
                ...
                foreach (var record in elementOuts)
                {
                    ...
                    if (record.I31Number != null && record.I31Number.Count() == record.I32Date.Count() && record.I31Number.Count() == record.I33State.Count())
                    {
                        ...
                        for (var i = 0; i < record.I31Number.Count(); i++)
                        {
                    ...
                    if (record.I51ClasNumber != null && record.I51ClasNumber.Count() > 0)
                    {
                        ...
                        for (var i = 0; i < record.I51ClasNumber.Count(); i++)
                        {
                    ...
                    if (record.I57 != null)
                    {
                        ...
                        var desc = new Abstract { Text = record.I57, Language = "EN" };
        ...
        public static List<Diamond.Core.Models.LegalStatusEvent> Sub06LegalEventConvertation(List<ProcessLegalEvents.Sub06ElementOut> elementOuts, string subcode)
        {
            /*list of record for whole gazette chapter*/
            var fullGazetteInfo = new List<Diamond.Core.Models.LegalStatusEvent>();
            if (elementOuts != null)
            {
                ...
                foreach (var record in elementOuts)
                {
                    ...
                    /*Elements output*/
                    biblioData.Publication.Number = record.I11;
                    //legalEvent.LegalEvent.Number = record.LeNumber;
                    legalEvent.LegalEvent.Date = record.EventDate;
                    legalEvent.LegalEvent.Language = "EN";
                    legalEvent.LegalEvent.Note = "|| Decision No | " + record.LeNumber;
                    legalEvent.Biblio = biblioData;
                    fullGazetteInfo.Add(legalEvent);
                }
            }
